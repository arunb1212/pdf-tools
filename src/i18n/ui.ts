...
export const ui = {
  en: make("en", {
    ...
    viaServer: "· via secure server",
    doneSplitOne: "1 × PDF extracted",
    doneSplitMany: "{n} × PDF extracted",
    doneSplitPages: "{n} single-page PDFs created",
    doneLocked: "Locked · {size}",
    doneUnlocked: "Unlocked · {size}",
    doneImages: "{n} images · {size}",
    imageUnit: "images",
    doneRows: "Extracted {n} rows · {size}",
    doneOcr: "OCR complete · {n} rows · {size}",
    doneTable: "{cols} columns · {rows} rows · {size}",
    doneCompressed: "Compressed from {a} to {b} ({p}% smaller)",
    doneOptimal: "Already at maximum compression ({size})",
    doneSigned: "Signature applied to page {page} of {pages}",
    doneRedacted: "Permanently redacted {n} areas across {pages} pages",
  ...
  de: make("de", {
    ...
    viaServer: "· über sicheren Server",
    doneSplitOne: "1 × PDF extrahiert",
    doneSplitMany: "{n} × PDF extrahiert",
    doneSplitPages: "{n} einseitige PDFs erstellt",
    doneLocked: "Gesperrt · {size}",
    doneUnlocked: "Entsperrt · {size}",
    doneImages: "{n} Bilder · {size}",
    imageUnit: "Bilder",
    doneRows: "{n} Zeilen extrahiert · {size}",
    doneOcr: "OCR fertig · {n} Zeilen · {size}",
    doneTable: "{cols} Spalten · {rows} Zeilen · {size}",
    doneCompressed: "Von {a} auf {b} komprimiert ({p} % kleiner)",
    doneOptimal: "Bereits maximal komprimiert ({size})",
    doneSigned: "Signatur auf Seite {page} von {pages} eingefügt",
    doneRedacted: "{n} Bereiche auf {pages} Seiten dauerhaft geschwärzt",
